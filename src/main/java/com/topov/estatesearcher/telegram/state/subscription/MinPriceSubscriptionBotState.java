...
public class MinPriceSubscriptionBotState extends AbstractSubscriptionBotState {
    ...
    @Autowired
    public MinPriceSubscriptionBotState(SubscriptionCache subscriptionCache, MessageSource messageSource) {
        super(BotStateName.SUBSCRIPTION_MIN_PRICE, messageSource, subscriptionCache);
    }
