...
@Log4j2
@Service
public class MinPriceSubscriptionHandler extends AbstractSubscriptionHandler {

    @Autowired
    public MinPriceSubscriptionHandler(BotStateEvaluator stateEvaluator,
                                       SubscriptionCache subscriptionCache,
                                       SubscriptionService subscriptionService,
                                       SubscriptionHandlerEvaluator stepEvaluator,
                                       UpdateResultFactory updateResultFactory) {
        super(SubscriptionHandlerName.MIN_PRICE, stateEvaluator, stepEvaluator, subscriptionCache, subscriptionService, updateResultFactory);
    }
    ...
    public UpdateResult handleSubscriptionStep(Update update) {
        ...
        switch (text) {
            ...
            default: return this.handleMinPriceUpdate(update);
        }
    }
